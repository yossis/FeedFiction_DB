  ...
  jQuery(function() {
    if ($('.pagination').length) {
      $(window).scroll(function() {
        ...
        if (url !== void 0 && url.length > 1 && $(window).scrollTop() > $(document).height() - $(window).height() - 50) {
...
(function() {
  ...
  jQuery(function() {
    return $('a.like-link').live('click', function() {
      var target, url;
      target = ($(this)).attr('data-target');
      url = ($(this)).attr('href');
